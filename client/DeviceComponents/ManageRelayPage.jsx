            ...
            <Jumbotron>
                <Container>
                    ...
                    <Row>
                        ...
                        <Col><Link to="/login"><Button variant="outline-primary"><CalendarIcon size={16} /> Schedule...</Button></Link></Col>
                        <Col><Link to="/login"><Button variant="outline-primary"><HistoryIcon size={16} /> Loop interval</Button></Link></Col>
                    </Row>
                </Container>
            </Jumbotron>
        )
